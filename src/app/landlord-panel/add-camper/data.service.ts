...
export class DataService {
    ...
    saveCamperDetails(params): Observable<any> {
        const url = `${this.baseUrl}/landlord/add-vehicle-step-one`

        return this.http.post<any>(url, params)
    }
    saveCamperProfile(params): Observable<any> {
        const url = `${this.baseUrl}/landlord/add-vehicle-step-two`

        return this.http.post<any>(url, params)
    }
    saveCamperLocation(params): Observable<any> {
        const url = `${this.baseUrl}/landlord/add-vehicle-step-three`

        return this.http.post<any>(url, params)
    }
    saveCamperConditions(params): Observable<any> {
        const url = `${this.baseUrl}/landlord/add-vehicle-step-four`
    ...
    getAmenitesList(): Observable<any> {
